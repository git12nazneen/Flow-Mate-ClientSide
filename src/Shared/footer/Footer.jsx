    ...
    <footer className="bg-white dark:bg-gray-900 mt-10">
      <div className="container px-6 py-10 mx-auto">
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 sm:gap-y-10 lg:grid-cols-4 pb-6">
          <div className="flex flex-col items-center justify-center sm:col-span-2 lg:items-start">
            <h1 className="max-w-lg text-xl font-semibold tracking-tight text-gray-800 xl:text-2xl dark:text-white lg:text-start text-center md:text-center">
                ...
                <Dialog.Portal>
                  ...
                  <Dialog.Content className="bg-white rounded-lg p-6 shadow-lg fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
                    ...
                    <Dialog.Description className="mt-2">
                      Here you have the ability to manage your tasks and projects. Get started by creating a new project. What are you waiting for?
                    </Dialog.Description>
        ...
        <div className="flex items-center justify-between flex-col lg:flex-row">
          ...
          <div className="flex -mx-2 mt-4 lg:mt-0">
            <a
